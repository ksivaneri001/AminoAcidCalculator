...
def allAtOnce():
  ...
  print('')
  print("Note: If the number of bases typed is less than 3, an error will occur. If the number of bases typed is greater than 3 but is not a multiple of 3, then the error can be ignored. It simply means that the last bases in the mRNA did not make up a codon.")
  x = 0
  ...
  while True:
    ...
    if newBase == "U" or newBase == "C" or newBase == "A" or newBase == "G":
      ...
      print("Not an mRNA base or not the word 'END'")
      break
